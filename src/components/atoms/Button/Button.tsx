...
const ButtonContent = ({
    ...
    <span className='relative block overflow-hidden'>
        ...
        <span
            ...
            className={clsx(
                'absolute inset-0 block transition-transform ease-editorial',
                !loading &&
        ...
        <span
            ...
            className='absolute inset-0 flex items-center justify-center transition-transform ease-editorial'
        >
